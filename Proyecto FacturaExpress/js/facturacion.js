...
const FacturacionModule = {
    ...
    // Generar facturas de ejemplo (delegado a core.js)
    generarFacturasEjemplo: function() {
        return FacturaExpress.SampleData.generarFacturasEjemplo(25);
    },
    ...
    generarContenidoFactura: function(factura) {
        return `
            ...
            <body>
                ...
                <div class="total">
                    TOTAL A PAGAR: ${FacturaExpress.utils.formatMoney(factura.monto)}
                </div>
